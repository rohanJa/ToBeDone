...
export default class CreateTodo extends Component{
    ...
    constructor(props){
        ...
        this.todo_responsible = this.onChangeTodoResponsible.bind(this)
        this.todo_description = this.onChangeTodoDescription.bind(this)
        this.todo_priority = this.onChangeTodoPriority.bind(this)
